...
def ScheduleAssetsOnDateForCustomer(asset, quantity, date, customer):
    ...
    time.sleep(2)
    field = wait.until(EC.element_to_be_clickable((By.XPATH,"/html/body/div[24]/div[2]/div[2]/div/div/div[1]/table/tbody/tr/td[1]"))).click()
    time.sleep(1)
    ...
    time.sleep(2)
    field = wait.until(EC.presence_of_element_located((By.XPATH,"/html/body/div[23]/div[2]/div[4]/div/div/div/div[1]/div/table/tbody/tr/td/div/div/ol/li/div[2]/table/tbody/tr[2]/td[7]/span/span/input[2]"))).send_keys(quantity)
    time.sleep(0.75)
...
def AssignShipTo(shipto):
    ...
    time.sleep(1)
    field = wait.until(EC.element_to_be_clickable((By.XPATH,"/html/body/div[84]/div[2]/div[2]/div/div/div[1]/table/tbody/tr/td[1]"))).click()
    time.sleep(2)
